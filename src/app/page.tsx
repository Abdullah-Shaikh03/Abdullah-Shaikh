...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        id="about"
        className="py-16 sm:py-20 px-4 bg-background/80 backdrop-blur-md"
      >
        <motion.div
        ...
        >
          ...
          <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
            I&apos;m a passionate Full Stack Developer with a strong focus on AI
            and Machine Learning. Currently pursuing my Bachelor&apos;s in
            Computer Science and Engineering, I&apos;ve developed a diverse
            skill set that allows me to create innovative solutions across
            various domains.
          </p>
...
const projects: Project[] = [
  {
    title: "RESHALA",
    description:
      "A C2C platform for exchanging used academic books and accessories.",
    technologies: [
      "HTML5",
      "CSS",
      "Bootstrap5",
  ...
  },
  {
    ...
    description:
      "Deep Neural Network model to analyze and predict 400+ skin diseases from photographs.",
  ...
  },
  {
    ...
    description:
      "Research project achieving 97.5% accuracy in glaucoma detection using custom CNN architecture.",
  ...
  },
  {
    ...
    description:
      "RNN-based system capable of detecting 7 different emotional states from audio input.",
